    ...
    return (
      ...
      <div className=''>
        <div className='card bg-base-100 shadow-xl rounded-3xl'>
          ...
          <Link href='/CarDoctor' target='_blank'> <button className='lg:px-20 px-2 py-2 btn btn-primary bg-[#d9d9d9]  lg:text-xl rounded-xl mt-5 lg:mb-2'>Projektdetails</button></Link>
              </div>
              <br />
              <br />
        </div>

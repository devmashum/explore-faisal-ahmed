        ...
        <div className=''>
          <div className='card bg-base-100 shadow-xl rounded-3xl'>
            ...
            <div className='lg:p-10 p-3 grid grid-cols-3 gap-3 lg:grid-cols-3 text-center mx-auto'>
              ...
              <Link href='/Kioko' target='_blank'> <button className='lg:px-20 px-2 py-2 btn btn-primary bg-[#d9d9d9]  lg:text-xl rounded-xl mt-5 lg:mb-2'>Project Details</button></Link>
              </div>
              <br />
              <br />
          </div>
